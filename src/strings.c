...
const u8 gText_BoxLinkDisabled[] = _("You cannot use the\nBOX LINK here.{PAUSE_UNTIL_PRESS}");
const u8 gText_MedKitDisabled[] = _("You cannot use the\nMED KIT here.{PAUSE_UNTIL_PRESS}");
const u8 gText_SyringeDisabled[] = _("You cannot use the\nPOWDER JAR here.{PAUSE_UNTIL_PRESS}");
const u8 gText_MedKit_Used[] = _("Your party was healed.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ForeverRepel_Activate[] = _("You sprayed the\nFOREVER REPEL.{PAUSE_UNTIL_PRESS}");
const u8 gText_ForeverRepel_Deactivate[] = _("The FOREVER REPEL\nwears off...{PAUSE_UNTIL_PRESS}");
const u8 gText_ForeverRepel_AlreadyActive[] = _("But the effects of a REPEL\nlingered from earlier.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RocketWhichTMHowMany[] = _("Heh, {STR_VAR_1}? Good taste.\nHow many you want, kid?");
const u8 gText_RocketConfirmTMPurchase[] = _("So {STR_VAR_1}, and you want {STR_VAR_2}?\nThat'll run you ¥{STR_VAR_3}. Deal?");
...
const u8 gText_RocketTMHandover[] = _("Sweet! Here's your TM!\nKeep this quiet, got it?");
...
const u8 gText_RocketNotEnoughMoney[] = _("Hey, what gives? You're short!\pCome back when you've got the cash.\nI can't go any lower than that!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RocketNeedAnotherTM[] = _("Need another TM?\nI still got plenty, kid.");
