const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SEADRA]     = {{EVO_LEVEL, 44, SPECIES_KINGDRA}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL, 31, SPECIES_PORYGON2}},
    ...
    [SPECIES_ELEKID]     = {{EVO_LEVEL, 24, SPECIES_ELECTABUZZ}},
    [SPECIES_MAGBY]      = {{EVO_LEVEL, 24, SPECIES_MAGMAR}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL_SILCOON, 18, SPECIES_HUNTAIL},
                            {EVO_LEVEL_CASCOON, 18, SPECIES_GOREBYSS}},
