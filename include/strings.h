...
extern const u8 gText_RocketNotEnoughMoney[];
extern const u8 gText_Var1CertainlyHowMany[];
extern const u8 gText_RocketNeedAnotherTM[];
extern const u8 gText_RocketTMHandover[];
extern const u8 gText_RocketWhichTMHowMany[];
extern const u8 gText_RocketConfirmTMPurchase[];
